...
l.65 リニアサーチで市町村を検索する

l.72 データの数の中で1つずつデータが見つかるまで繰り返す

l.74 データがあったら、resultとし、終了

l.84 バイナリサーチで市町村を検索する

l.91 leftがrightより小さい間繰り返す

l.93 posに left + (right - left) / 2 を代入

l.95 データがあったら、resultとし、終了

l.100 データより大きかったら、left = pos + 1 とする

l.104 それ以外の時、right = pos - 1 とする
